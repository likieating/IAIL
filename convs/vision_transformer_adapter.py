...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, global_pool=False, img_size=224, patch_size=16, in_chans=3, num_classes=2, embed_dim=768,
                 depth=12,
...
def vit_base_patch16_224_adapter(pretrained=False, **kwargs):
    ...
    checkpoint_model = timm.create_model("vit_base_patch16_224", pretrained=False, num_classes=2)

    # Step 2: 从本地路径加载权重
    local_weights_path = "/home/tangshuai/dmp-bk/pre_weights/timmvit_base_patch16_224.bin"  # 替换为本地权重文件路径
