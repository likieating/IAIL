...
class DFIL_xception(BaseLearner):
    def __init__(self, args):
        super().__init__(args)
        self.args = args
        self._network = xception(2, weight_path='/home/tangshuai/dmp-bk/pre_weights/xception-43020ad28.pth',
                                 pre_imgnet=True)
        self.best_model_path = ['/home/tangshuai/dmp-bk/logs/benchmark/OSMA/split1/dfil_xception/0112-19-04-25-762_OSMA_split1_resnet32_1993_B0_Inc1/task0/val_acc95.41_model.pth']
