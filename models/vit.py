...
def build_net():
    # model = timm.create_model('vit_base_patch16_224', num_classes=2, pretrained=False, checkpoint_path='/home/tangshuai/.cache/huggingface/hub/models--timm--vit_base_patch16_224.augreg2_in21k_ft_in1k/B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_224.npz')
    model = vit_base_patch16_224(False, num_classes=2)
