...
from models.identity.loss.ucfloss import CrossEntropyLoss,ContrastiveLoss,L1Loss
...
class UCFDetector(AbstractDetector):
    ...
    def build_loss(self):
        ...
        spe_loss_class = CrossEntropyLoss
    ...
    def get_train_losses(self, data_dict: dict, pred_dict: dict) -> dict:
        ...
        # loss = loss_sha  + 0.3 * loss_reconstruction+0.05 * loss_con
        loss_dict = {
            'overall': loss,
            'common': loss_sha,
            'specific': loss_spe,
    ...
    def forward(self, data_dict: dict, inference=False) -> dict:
        ...
        if inference:
            ...
            # out_add=out_spe+out_sha
            # out_concat = torch.cat((out_spe, out_sha), dim=1)
            ...
            pred_dict = {'cls': out_sha,'cls_spe':out_spe, 'feat': sha_feat,'feat_spe':spe_feat}
            return pred_dict
