...
class img_selector(nn.Module):
    def __init__(self,net,device,stage,input_size=299,num_crop=10,factor=2,ipc=100):
        super().__init__()
        self.net=net
        self.n=20
        self.stage=stage
    ...
    def forward(self,data_manager,taskk):
        ...
        images_total_real=torch.zeros(0,3,149,149).to(self._device)
        images_total_fake = torch.zeros(0, 3, 149, 149).to(self._device)
