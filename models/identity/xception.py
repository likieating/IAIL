...
class Xception(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        self.block9_add =Block(728, 1024, 3, 1, start_with_relu=True, grow_first=False)
    ...
    def forward(self, input):
        ...
        features_d = F.adaptive_avg_pool2d(features, (1, 1))
        features_d = features_d.view(features_d.size(0), -1)
        logits = self.logits(features_d)
...
def xception(num_classes: int = 2, weight_path: str = '/home/tangshuai/dmp-bk/pre_weights/xception-43020ad28.pth', pre_imgnet: bool = False, **kwargs):
