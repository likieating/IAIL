...
class identity_xception(BaseLearner):
    def __init__(self, args):
        super().__init__(args)
        self.args = args
        self._network = xception(2, weight_path='/home/tangshuai/dmp-bk/pre_weights/xception-43020ad28.pth',
                                 pre_imgnet=True)
        self.best_model_path = ['/home/tangshuai/dmp-bk/logs/benchmark/OSMA/split1/identity_xception/0228-11-29-46-622_OSMA_split1_xception_1993_B0_Inc1/task0/val_acc94.99_model.pth']
    ...
    def _init_train(self, train_loader, val_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets, order) in enumerate(train_loader):
                ...
                consup_loss = 0.05 * _ConSup_loss(features, targets)
    ...
    def _update_representation(self, train_loader, val_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (paths, inputs, targets, orders) in enumerate(train_loader):
                ...
                loss = cls_loss + 0.05 * consup_loss + kd_loss
                # loss = cls_loss
