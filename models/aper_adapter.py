...
from utils.inc_net_rcil import IncrementalNet, SimpleCosineIncrementalNet, MultiBranchCosineIncrementalNet, SimpleVitNet
from models.base_rcil import BaseLearner
...
class RCIL_Learner(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        self.train_loader_for_protonet = DataLoader(
            train_dataset_for_protonet, batch_size=batch_size, shuffle=False, num_workers=num_workers, pin_memory=True
        )
