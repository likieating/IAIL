...
from convs.vit_adapter import vit_adapter_patch16_224
    ...
    def _train(self, train_loader, val_loader):
        ...
        if self._cur_task == 0:
            ...
            e_optimizer = optim.Adam(filter(lambda p: p.requires_grad, self._network.parameters()), lr=lrate,
                                     weight_decay=weight_decay)
            e_scheduler = optim.lr_scheduler.StepLR(optimizer=e_optimizer, step_size=update_step_size, gamma=lrate_decay)
